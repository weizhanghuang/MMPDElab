function ex2d_2_Lshape()
%
% example for adaptive mesh generation for given functions on L-shaped domain
%
% an example to show how to merge several non-overlapping meshes.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% set the initial meshes, find the indices of the corner points and fix them
   ...
   kmax = jmax;
   [X1,tri1] = MovMesh_rect2tri(linspace(0,0.5,jmax),linspace(0,0.5,kmax),1);
   [X2,tri2] = MovMesh_rect2tri(linspace(0,0.5,jmax),linspace(0.5,1,kmax),1);
   [X3,tri3] = MovMesh_rect2tri(linspace(0.5,1,jmax),linspace(0.5,1,kmax),1);
   ...
   corners = [0,0;0.5,0;0.5,0.5;1,0.5;1,1;0,1];
