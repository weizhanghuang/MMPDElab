function err = MovFEM_Error_P1L2(uexact,t,X,U,tri,tri_bf,varargin)
%
% usage: err = MovFEM_Error_P1L2(uexact,t,X,U,tri,tri_bf,varargin)
%
% this function computes the L2 error in P1 finite element approximation.
%
