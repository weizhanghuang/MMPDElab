...
% for time integration
   ...
   case 'ode15s'
      ...
      [~,xnew]=ode15s(@MovMesh_rhs,[tspan(1),tspan(end)],x,opts,X,M,tau, ...
                      tri,tri_bf,bfE,nodes_fixed,G_fun,Xi_ref);
...
function F = MovMesh_rhs(t,x,Xcurrent,M0,tau,tri,tri_bf,bfE,nodes_fixed,G_fun,Xi_ref)
%
...
% modify forces at boundary points
   ...
   case 2
      ...
      if (fixed)
         ...
         vn = MovMesh_freeBoundary_vertexNormal(X,tri,tri_bf,bfE);
...
function JAC = MovMesh_jac(t,x,Xcurrent,M0,tau,tri,tri_bf,bfE,nodes_fixed,G_fun,Xi_ref)
%
